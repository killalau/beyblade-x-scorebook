...
assert.match(html, /id="inventoryPartSearch"/);
assert.match(html, /id="inventoryPartTabs"/);
assert.match(html, /data-category="Lock Chip"/);
assert.match(html, /data-category="other"/);
...
assert.match(appSource, /findCatalogueListingForBey/);
assert.match(appSource, /purchasePaidAmount/);
